...
$Shortcut.Arguments = "-NoProfile -ExecutionPolicy Bypass -File `"D:\openclaw\scripts\restart-gateway-safe.ps1`""
$Shortcut.WorkingDirectory = "D:\openclaw\scripts"
...
$Shortcut.TargetPath = "powershell.exe"
$Shortcut.Arguments = "-NoProfile -ExecutionPolicy Bypass -File `"D:\openclaw\scripts\check-gateway-health.ps1`""
$Shortcut.WorkingDirectory = "D:\openclaw\scripts"
