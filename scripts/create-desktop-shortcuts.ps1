...
$Shortcut.Arguments = "-NoProfile -ExecutionPolicy Bypass -File `"D:\AI编程\openclaw\scripts\restart-gateway-safe.ps1`""
$Shortcut.WorkingDirectory = "D:\AI编程\openclaw\scripts"
...
$Shortcut.TargetPath = "powershell.exe"
$Shortcut.Arguments = "-NoProfile -ExecutionPolicy Bypass -File `"D:\AI编程\openclaw\scripts\check-gateway-health.ps1`""
$Shortcut.WorkingDirectory = "D:\AI编程\openclaw\scripts"
...
# 3. 查看日志快捷方式
$logDir = "D:\AI编程\openclaw\.openclaw\logs"
