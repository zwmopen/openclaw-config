...
$repoPath = "D:\Program Files\Obsidian\zwm\.zwm"

Write-Log "=========================================="
Write-Log "Obsidian Auto Backup Start"
Write-Log "=========================================="
...
try {
    ...
    Write-Log "=========================================="
    Write-Log "Obsidian Auto Backup Complete"
    Write-Log "=========================================="
}
catch {
    Write-Log "Error: $_"
    Write-Log "=========================================="
    Write-Log "Obsidian Auto Backup Failed"
    Write-Log "=========================================="
    exit 1
}
