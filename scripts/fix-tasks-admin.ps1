...
Write-Host "1?? 更新 OpenClaw-Gateway-AutoStart..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "2?? 删除 OpenClaw-Gateway-Check..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "3?? 修复 OpenClaw_OpenADrive..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "4?? 删除 OpenClaw_Restart_Reminder..." -ForegroundColor Yellow
