...
description: Self-reflection + Self-criticism + Self-learning + Self-organizing memory. Agent evaluates its own work, catches mistakes, and improves permanently. Use this skill before starting work and after responding to the user.
changelog: "Turned self-improving into a true always-on loop: pre-task activation, post-response reflection, and tighter continuous learning behavior."
